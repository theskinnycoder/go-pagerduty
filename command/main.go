...
func loadCommands() map[string]cli.CommandFactory {
	return map[string]cli.CommandFactory{
		...
		"incident past":          IncidentPastCommand,
		"incident related":       IncidentRelatedCommand,
		"incident outlier":       IncidentOutlierCommand,
		"incident change-events": IncidentChangeEventsCommand,
		"incident alert list":    IncidentAlertListCommand,
		"incident alert show":    IncidentAlertShowCommand,
		"incident responder add": IncidentResponderAddCommand,
